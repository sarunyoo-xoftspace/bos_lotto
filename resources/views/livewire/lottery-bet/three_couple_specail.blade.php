...
<div class="row">
    <div class="col-xl-4 col-md-4 mb-4 form-group">
        <input type="text" class="form-control @error('threeNumbetBet') is-invalid @enderror"
            wire:model="threeNumbetBet" placeholder="กรอกตัวเลข 3 ตัว" maxlength="3" />
    ...
    <div class="col-xl-4 col-md-4 mb-4 form-group">
        <input type="text" class="form-control @error('bathBetPerNumber') is-invalid @enderror"
            wire:model="bathBetPerNumber" placeholder="จำนวนเงินแทง" maxlength="8" />
    ...
    <div class="col-xl-4 col-md-4 mb-4 form-group">
        <button type="button" class="btn btn-block btn-warning" wire:click="addBetThreeDigitCoupleSpecial">
            {{ __('ยืนยันการแทง') }}
        </button>
    </div>
