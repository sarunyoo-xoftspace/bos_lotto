                ...
                <div class="card-body">
                    ...
                    <div class="row form-row no-gutters">
                        <div class="col-xl-6 col-md-6 mb-6 form-group">
                            ...
                            <input type="text" class="form-control text-center @error('first_prize') is-invalid @enderror" id="first_prize" wire:model="first_prize">
                            @error('first_prize')
                        ...
                        <div class="col-xl-6 col-md-6 mb-6 form-group">
                            ...
                            <input type="text" class="form-control text-center @error('two_digit_suffix') is-invalid @enderror" id="two_digit_suffix" wire:model="two_digit_suffix">
                    ...
                    <div class="row form-row no-gutters">
                        ...
                        <div class="col-xl-3 col-md-3 mb-3 form-group">
                            ...
                            <input type="text" class="form-control text-center @error('three_digit_prefix_1') is-invalid @enderror" id="three_digit_prefix_1" wire:model="three_digit_prefix_1">
                        ...
                        <div class="col-xl-3 col-md-3 mb-3 form-group">
                            ...
                            <input type="text" class="form-control text-center @error('three_digit_prefix_2') is-invalid @enderror" id="three_digit_prefix_2" wire:model="three_digit_prefix_2">
                        ...
                        <div class="col-xl-3 col-md-3 mb-3 form-group">
                            ...
                            <input type="text" class="form-control text-center @error('three_digit_suffix_1') is-invalid @enderror" id="three_digit_suffix_1" wire:model="three_digit_suffix_1">
                        ...
                        <div class="col-xl-3 col-md-3 mb-3 form-group">
                            ...
                            <input type="text" class="form-control text-center @error('three_digit_suffix_2') is-invalid @enderror" id="three_digit_suffix_2" wire:model="three_digit_suffix_2">
